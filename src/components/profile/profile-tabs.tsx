      ...
      {earnedBadges.length > 0 ? (
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-2">
            <Sparkles className="text-sky-700" size={20} />
            ...
            {earnedBadges.map((badge) => {
              ...
              return (
                <span
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full bg-cyan-100 px-3 py-1 text-sm font-semibold text-cyan-800"
                >
                  <Award size={14} />
          ...
          <div className="mt-4 space-y-4">
            {category.items.map((item) => (
              <div key={item.code}>
                <div className="flex items-center gap-2">
                  ...
                  <p
                    className={`text-sm font-semibold ${
                      item.earned ? "text-slate-950" : "text-slate-500"
                    }`}
                  >
                    {item.title}
                  </p>
                ...
                <div className="mt-2 ml-6 h-1.5 overflow-hidden rounded-full bg-slate-100">
                  <div
...
function ActivityTab({
  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex items-center gap-2">
        <Flame className="text-sky-700" size={20} />
        <h2 className="text-lg font-semibold text-slate-950">
