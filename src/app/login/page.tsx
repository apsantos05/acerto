...
export default function LoginPage() {
  return (
    <main className="grid min-h-screen bg-[#f7fbff] lg:grid-cols-[0.9fr_1.1fr] dark:bg-slate-950">
      <section className="flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-xl shadow-sky-950/10 dark:border-slate-800 dark:bg-slate-900">
          <Link href="/" className="mb-8 flex items-center gap-2 text-slate-950 dark:text-white">
