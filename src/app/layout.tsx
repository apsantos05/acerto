...
const themeScript = `(function(){try{var t=localStorage.getItem('acerte-theme');var d=t?t==='dark':window.matchMedia('(prefers-color-scheme: dark)').matches;if(d)document.documentElement.classList.add('dark');}catch(e){}})();`;
